...
Shader::Shader(std::string vertexSrc, std::string fragmentSrc, std::string geometrySrc, bool isFromFile)
{
    std::string vertexCode = vertexSrc;
    std::string fragmentCode = fragmentSrc;
    std::string geometryCode = geometrySrc;
    if (isFromFile) {
